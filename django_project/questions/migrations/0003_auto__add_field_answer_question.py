...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'questions_answer', 'question',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['questions.Question']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.question'
        db.delete_column(u'questions_answer', 'question_id')
