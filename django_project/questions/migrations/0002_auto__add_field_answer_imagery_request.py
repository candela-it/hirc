...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.imagery_request'
        db.add_column(u'questions_answer', 'imagery_request',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['imagery_requests.ImageryRequest']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.imagery_request'
        db.delete_column(u'questions_answer', 'imagery_request_id')
