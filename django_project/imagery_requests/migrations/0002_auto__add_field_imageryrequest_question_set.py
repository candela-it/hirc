...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageryRequest.question_set'
        db.add_column(u'imagery_requests_imageryrequest', 'question_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questions.QuestionSet'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImageryRequest.question_set'
        db.delete_column(u'imagery_requests_imageryrequest', 'question_set_id')
