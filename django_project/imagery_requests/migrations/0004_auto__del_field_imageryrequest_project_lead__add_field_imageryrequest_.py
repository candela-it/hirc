...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ImageryRequest.project_lead'
        db.delete_column(u'imagery_requests_imageryrequest', 'project_lead_id')

        # Adding field 'ImageryRequest.request_lead'
        db.add_column(u'imagery_requests_imageryrequest', 'request_lead',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='request_lead', null=True, to=orm['imagery_requests.CustomUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ImageryRequest.project_lead'
        db.add_column(u'imagery_requests_imageryrequest', 'project_lead',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_lead', null=True, to=orm['imagery_requests.CustomUser']),
                      keep_default=False)

        # Deleting field 'ImageryRequest.request_lead'
        db.delete_column(u'imagery_requests_imageryrequest', 'request_lead_id')
