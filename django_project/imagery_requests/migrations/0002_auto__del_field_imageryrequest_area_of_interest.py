...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ImageryRequest.area_of_interest'
        db.delete_column(u'imagery_requests_imageryrequest', 'area_of_interest')


    def backwards(self, orm):
        # Adding field 'ImageryRequest.area_of_interest'
        db.add_column(u'imagery_requests_imageryrequest', 'area_of_interest',
                      self.gf('django.contrib.gis.db.models.fields.PolygonField')(default=1),
                      keep_default=False)
    ...
    models = {
        ...
        u'imagery_requests.requestdate': {
            ...
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(0, 0)', 'null': 'True', 'blank': 'True'})
        },
